...
import { estimateTableHeightPx } from "./line-height-table-extra";
...
// Re-export table row slice + paragraph spacing helpers from the split module.
export * from "./line-height-table-extra";
