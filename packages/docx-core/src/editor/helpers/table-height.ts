...
import { tableCellParagraphsRecursively } from "./paragraph-inspect";
...
// TODO: port upstream table-height-specific helpers that depend on modules still missing in docx-core.
...
export function resolveTableCellBlockStyle(style: TableCellStyle | undefined): StyleRecord {
  return {
...
export function resolveTableParagraphLineHeightContext(paragraph: ParagraphNode): number {
...
export function resolveTableParagraphNextTabStopPx(currentLineWidthPx: number, tabStopsPx: number[]): number {
