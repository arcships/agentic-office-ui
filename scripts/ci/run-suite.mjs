...
const suites = {
  ...
  component: [
    ...
    command("vue-component-behavior", process.execPath, [
      ...
      "tests/component/office-selection-ui.test.mjs",
      "tests/component/office-reference-surfaces.test.mjs",
